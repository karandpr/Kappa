...
#define MSMFB_DTV_LCDC_ENABLE     _IOW(MSMFB_IOCTL_MAGIC, 147, unsigned int)
#define MSMFB_OVERLAY_REFRESH     _IOW(MSMFB_IOCTL_MAGIC, 148, unsigned int)
#define MSMFB_OVERLAY_3D       _IOWR(MSMFB_IOCTL_MAGIC, 149, \
						struct msmfb_overlay_3d)

#define MSMFB_MIXER_INFO       _IOWR(MSMFB_IOCTL_MAGIC, 150, \
						struct msmfb_mixer_info_req)
#define MSMFB_OVERLAY_PLAY_WAIT _IOWR(MSMFB_IOCTL_MAGIC, 151, \
						struct msmfb_overlay_data)
#define MSMFB_WRITEBACK_INIT _IO(MSMFB_IOCTL_MAGIC, 152)
#define MSMFB_WRITEBACK_START _IO(MSMFB_IOCTL_MAGIC, 153)
#define MSMFB_WRITEBACK_STOP _IO(MSMFB_IOCTL_MAGIC, 154)
#define MSMFB_WRITEBACK_QUEUE_BUFFER _IOW(MSMFB_IOCTL_MAGIC, 155, \
						struct msmfb_data)
#define MSMFB_WRITEBACK_DEQUEUE_BUFFER _IOW(MSMFB_IOCTL_MAGIC, 156, \
						struct msmfb_data)
#define MSMFB_WRITEBACK_TERMINATE _IO(MSMFB_IOCTL_MAGIC, 157)
#define MSMFB_MDP_PP _IOWR(MSMFB_IOCTL_MAGIC, 158, struct msmfb_mdp_pp)
